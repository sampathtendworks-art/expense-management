...
export const Approvals: React.FC = () => {
  ...
  const currentUserName = roleMeta[currentRole]?.name || 'Priya Nair';
  ...
  const handleModalSubmit = () => {
    ...
    if (actionModal.claimId) {
      if (actionModal.type === 'reject') {
        rejectClaimWithReason(actionModal.claimId, actionModal.reasonText, currentUserName);
      } else if (actionModal.type === 'clarify') {
        requestClarification(actionModal.claimId, actionModal.reasonText, currentUserName);
      }
    } else if (actionModal.type === 'bulk_reject') {
      selectedIds.forEach(id => {
        rejectClaimWithReason(id, actionModal.reasonText, currentUserName);
      });
      setSelectedIds([]);
    }
  ...
  return (
    <div className="space-y-8 max-w-7xl mx-auto pb-20">
      <div className="flex justify-between items-center">
        <div>
          <h2 className="text-3xl font-black text-primary tracking-tight uppercase">Approvals Queue</h2>
        ...
        <div className="relative w-80">
          ...
          <input
            ...
            className="w-full pl-12 pr-4 py-3 bg-white border border-slate-200 rounded-xl text-sm font-bold focus:outline-none focus:border-accent shadow-sm transition-all"
          />
        </div>
      </div>

      {selectedIds.length > 0 && (
        <div className="bg-primary text-white p-5 rounded-2xl flex justify-between items-center shadow-xl">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-indigo-50/50 border-2 border-indigo-100 p-6 rounded-3xl space-y-5 shadow-sm animate-in fade-in duration-300">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <div className="p-2.5 bg-accent text-white rounded-xl shadow-md shadow-emerald-200">
                ...
                <button
                  ...
                  className="bg-accent text-white px-5 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-emerald-600 shadow-md shadow-accent/10 cursor-pointer"
                >
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        <div>
                          <p className="text-xs font-bold text-slate-900 leading-none">Employee</p>
                ...
                {standardClaims.length === 0 && (
                  <tr>
                    <td colSpan={6} className="p-20 text-center space-y-4">
                      ...
                      <div>
                        <h4 className="text-md font-black text-primary">Standard Inbox is Clear</h4>
        ...
        <div className="space-y-6">
          <div className="bg-primary text-white p-6 border border-slate-800 rounded-3xl shadow-xl space-y-6 flex flex-col justify-between min-h-[500px]">
            <div className="space-y-6">
            ...
            >
              ...
              <div className="p-6 bg-slate-50">
                <textarea
                  ...
                  className="w-full min-h-[140px] p-4 bg-white border border-slate-200 rounded-2xl focus:border-accent focus:ring-1 focus:ring-accent outline-none transition-all resize-none text-xs font-semibold"
